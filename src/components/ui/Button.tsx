    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            'bg-black text-white hover:bg-primary-800 shadow-sm hover:shadow-md': variant === 'primary',
            'bg-white text-black border-2 border-black hover:bg-black hover:text-white': variant === 'secondary',
            'border-2 border-black bg-transparent hover:bg-black hover:text-white': variant === 'outline',
